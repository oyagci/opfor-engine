...
project "opfor"
    ...
    files
    {
		...
		"%{prj.name}/src/opfor/renderer/Viewport.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLContext.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLVertexArray.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLBuffer.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLRendererAPI.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLTexture.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLRenderbuffer.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLFramebuffer.cpp",
		"%{prj.name}/src/platform/opengl/OpenGLShader.cpp",
		"%{prj.name}/src/platform/opengl/imgui_impl_opengl3.cpp",
		"%{prj.name}/src/platform/opengl/imgui_impl_glfw.cpp",
		"%{prj.name}/src/platform/linux/LinuxWindow.cpp",
		"%{prj.name}/src/platform/linux/LinuxInput.cpp",
		"%{prj.name}/src/platform/windows/WindowsInput.cpp",
