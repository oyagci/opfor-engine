...
void SkyboxRenderer::InitSkybox()
{
    ...
    constexpr std::array<opfor::CubemapFace, 6> faces{
        opfor::CubemapFace::PositiveX, opfor::CubemapFace::NegativeX, opfor::CubemapFace::PositiveY,
        opfor::CubemapFace::NegativeY, opfor::CubemapFace::PositiveZ, opfor::CubemapFace::NegativeZ,
    };
    ...
    const glm::uvec3 indices[] = {// front
                                  glm::uvec3(0, 3, 1), glm::uvec3(1, 3, 2),
                                  // right
                                  glm::uvec3(1, 2, 5), glm::uvec3(2, 6, 5),
                                  // back
                                  glm::uvec3(4, 5, 6), glm::uvec3(4, 6, 7),
                                  // left
                                  glm::uvec3(0, 4, 7), glm::uvec3(0, 7, 3),
                                  // bottom
                                  glm::uvec3(0, 1, 4), glm::uvec3(1, 5, 4),
                                  // top
                                  glm::uvec3(3, 7, 2), glm::uvec3(2, 7, 6)};
